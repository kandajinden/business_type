...
// 営業・企画・エンジニア・事務・クリエイティブ: v1→v2 4択化
// 経営者・役員 / 個人事業主・フリーランス: v2新規→4択化
// その他: v1→v2 4択化
// ========================================
...
const SALES_QUESTIONS: Question[] = [
  {
    ...
    text: "アポなし訪問。受付で「担当者は不在です」。これで3回目。",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "B", text: "「もし導入しなかった場合、今の課題はどう解決される予定ですか？」と逆質問", scores: { I: 2, A: 1, C: 1 } },
      { label: "C", text: "「判断材料として○○の資料も追加でお送りしますね」と次の接点を作る", scores: { C: 2, E: 1, G: 1 } },
      { label: "D", text: '「"検討します"って9割お断りの合図なんです。もしそうなら理由を教えてください」', scores: { L: 3, C: 1, A: 1, G: -1 } },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "「行動量」", scores: { E: 2, G: 2 } },
    ],
  },
];
...
const MARKETING_QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { label: "D", text: "まず上司に「3つのアイデアに求める方向性を教えてください」と確認しにいく", scores: { C: 1, A: 2, E: 1, I: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "残り予算でA/Bテストを3パターン回す", scores: { A: 2, I: 1, E: 2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "D", text: '競合のバズに乗っかって「比較コンテンツ」を出す', scores: { I: 2, C: 1, L: 1 } },
    ],
  },
  {
...
const ENGINEERING_QUESTIONS: Question[] = [
  {
    ...
    text: "コードレビュー。先輩の書いたコードに明らかな設計ミスを見つけた。チーム全員が見えるスレッド。",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "「○○の変更が怪しいです。一旦リバートしてもいいですか？」とチームに提案", scores: { C: 2, E: 1, L: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "上司の判断を尊重する。今のスタックで最高のものを作ることに集中", scores: { G: 2, E: 1, I: -2 } },
    ],
  },
  {
...
const ADMIN_QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { label: "B", text: "経費精算のフォーマットを改善して、そもそも間違えようがない仕組みを作る", scores: { I: 3, A: 1, E: 1 } },
      { label: "C", text: "その営業マンの上司に「部下の経費精算が毎回…」と伝える", scores: { C: 1, A: 1, L: 1, G: -1 } },
      { label: "D", text: "「一緒にやりましょうか」とその場で教える。仕組みより人", scores: { C: 3, L: 1, I: -1 } },
    ],
  },
  {
    id: "Q22_admin", number: 22, type: "choice", category: "job_specific", progressWeight: 4,
    text: '他部署の部長から「このデータ今日中に出せる？」と急な依頼。でも自分の締め作業もある。',
    options: [
      { label: "A", text: "「何時までに必要ですか？」と確認して、両方のスケジュールを組み直す", scores: { E: 3, A: 1, C: 1 } },
      { label: "B", text: "「今日は締め作業があるので明日でもいいですか？」と正直に断る", scores: { L: 2, E: 1, C: -1 } },
      { label: "C", text: "「このデータなら○○システムから自分で出せますよ」とセルフサービスの方法を教える", scores: { I: 2, E: 1, C: 1 } },
      { label: "D", text: "自分の上司に「どっち優先ですか？」と判断を仰ぐ", scores: { C: 1, A: 1, L: -1 } },
    ],
  },
  {
    id: "Q23_admin", number: 23, type: "choice", category: "job_specific", progressWeight: 4,
    text: '部署のルールブック。明らかに時代遅れの項目がある。「今どきFAXで報告って…」。',
    options: [
      ...
      { label: "C", text: "同じこと思ってる人を3人集めてから提案する", scores: { C: 2, L: 1, A: 1 } },
      { label: "D", text: "ルールはルール。守るのがプロ", scores: { G: 2, E: 1, I: -2 } },
    ],
  },
  {
...
const CREATIVE_QUESTIONS: Question[] = [
  {
    ...
    text: 'クライアントから3回目のリテイク。フィードバックは「もっとインパクトを」。',
    options: [
      ...
      { label: "D", text: "そもそも課題設定がズレてる。ブリーフからやり直しを提案する", scores: { L: 2, A: 1, I: 1, C: 1 } },
    ],
  },
  {
    id: "Q22_creative", number: 22, type: "choice", category: "job_specific", progressWeight: 4,
    text: '渾身のデザイン案。チーム内レビューで「ターゲットに刺さらないかも」とフィードバック。',
    options: [
      { label: "A", text: "「なぜ刺さらないと思うのか」を具体的に聞いて、データで検証する", scores: { A: 2, C: 1, I: 1 } },
      { label: "B", text: "ターゲット5人に実際に見せる。チームの感覚より、ユーザーの反応がすべて", scores: { A: 2, C: 1, I: 1, L: 1 } },
      { label: "C", text: '「刺さる版」と「自分版」の2つ出して、A/Bテストにかける', scores: { A: 2, I: 2, E: 1 } },
      { label: "D", text: "自分が最高だと思うものを出す。妥協したら最高のものは生まれない", scores: { G: 3, I: 1, C: -2 } },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "「才能がなくても、見る目があればディレクションで勝てる」", scores: { L: 2, A: 1 } },
    ],
  },
];
...
const EXECUTIVE_QUESTIONS: Question[] = [
  {
    ...
    text: "創業メンバーだった右腕が、明らかにパフォーマンスが落ちている。",
    options: [
      { label: "A", text: "本人と1on1で率直に話す。「君の強みがズレてきてる」と伝える", scores: { L: 3, C: 1, G: -1 } },
  ...
  },
  {
    ...
    text: '投資家から「このビジネスモデル、3年で黒字化できる根拠は？」。正直、根拠は弱い。',
    options: [
      { label: "A", text: "「根拠はこれです」と、ある数字を強気に出す。細かい穴は後で埋める", scores: { L: 3, G: 1, A: -1 } },
      { label: "B", text: "「正直、確実な根拠はまだありません。ただ、検証を進めています」と誠実に答える", scores: { C: 2, A: 2, L: -1 } },
      { label: "C", text: "ビジョンと市場の可能性の話に切り替える。数字じゃなく物語で引き込む", scores: { I: 2, C: 2, L: 1 } },
      { label: "D", text: "「3年黒字化」の前提自体に疑問を投げる。「5年で見てください」", scores: { A: 3, L: 1, I: 1 } },
    ],
  },
  {
    id: "Q23_executive", number: 23, type: "choice", category: "job_specific", progressWeight: 4,
    text: '社員50人。「経営陣は現場を分かってない」という声がSlackの裏チャンネルで飛び交ってるらしい。',
    options: [
      ...
      { label: "C", text: "組織設計の問題。マネージャー層を入れて、経営と現場のブリッジを作る", scores: { I: 2, A: 2, C: 1 } },
      { label: "D", text: "自分が現場に入る。1週間、社員と同じ仕事をして「分かってない」を潰す", scores: { E: 3, C: 1, L: 1 } },
    ],
  },
  {
...
const FREELANCE_QUESTIONS: Question[] = [
  {
    ...
    text: "月収が安定しない。先月は良かったけど、今月の見込みがほぼゼロ。貯金はあと3ヶ月分。",
    options: [
      { label: "A", text: "「今日中にアポを3件入れる」。とにかく動く。止まったら終わり", scores: { E: 3, G: 1, A: -1 } },
      { label: "B", text: "「月額制のサービスを作ろう」。構造的に変える", scores: { I: 2, A: 2, E: 1 } },
      { label: "C", text: "「前の取引先に連絡してみよう」。既存の関係が一番確度高い", scores: { C: 3, E: 1, L: -1 } },
      { label: "D", text: "「3ヶ月あるなら、今こそ自分のコンテンツを作る」。種まきに時間を使う", scores: { I: 2, L: 1, G: 1 } },
    ],
  },
  {
    id: "Q22_freelance", number: 22, type: "choice", category: "job_specific", progressWeight: 4,
    text: '「いつもの半額でやってくれない？ 今後たくさん発注するから」。今月の売上はキツい。',
    options: [
      { label: "A", text: "「今回だけ特別価格で」と受ける。まず実績と関係性を作る", scores: { C: 2, G: 1, E: 1 } },
      ...
      { label: "D", text: "断る。「安売りしたら自分の市場価値が下がる。一回でも下げたら戻せない」", scores: { L: 3, G: 1, C: -2 } },
    ],
  },
  {
    id: "Q23_freelance", number: 23, type: "choice", category: "job_specific", progressWeight: 4,
    text: "SNSのフォロワーが伸びてきた。でも売上が全然比例してない。",
    options: [
      { label: "A", text: '発信の内容を変える。「役立つ情報」から「自分にしかできない提案」に切り替える', scores: { I: 3, L: 1, C: -1 } },
      { label: "B", text: 'フォロワーに直接聞く。「何に困ってますか？」のアンケートを取る', scores: { C: 2, A: 2, I: 1 } },
      { label: "C", text: "SNSは認知の入口。売上はDMやメルマガの導線で作る。ファネルを設計する", scores: { A: 3, E: 1, I: 1 } },
...
const OTHER_QUESTIONS: Question[] = [
  {
    ...
    text: '実績ゼロ。「なぜあなたに頼む必要があるの？」と聞かれた。',
    options: [
      ...
      { label: "D", text: "「まず小さい仕事を1つください。結果で判断してください」", scores: { E: 2, C: 1, G: 1 } },
    ],
  },
  {
    id: "Q22_other", number: 22, type: "choice", category: "job_specific", progressWeight: 4,
    text: '「この見積もり高くない？ 相場の1.5倍だけど」と値下げ交渉。',
    options: [
      { label: "A", text: "「この金額の内訳と根拠はこうです」と明細を見せて説明", scores: { A: 2, C: 1, L: 1 } },
      { label: "B", text: "「何を削れば予算に合いますか？」とスコープ調整を提案", scores: { C: 2, A: 1, E: 1 } },
      { label: "C", text: "「この金額で受けるかは、このプロジェクトの魅力次第です」と対等な関係を示す", scores: { L: 3, I: 1, C: -1 } },
      { label: "D", text: "「相場の1.5倍の理由は、相場の3倍の結果を出すからです」", scores: { L: 2, G: 2, C: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "B", text: "月額制のサービスや顧問契約を作る。ストック収入を構造化する", scores: { A: 2, I: 2, E: 1 } },
      { label: "C", text: '前職の同僚に連絡する。「仕事ない？」で意外と繋がる', scores: { C: 3, E: 1, L: -1 } },
      { label: "D", text: "コンテンツを作って発信する。今月の仕事は来月の種まきで決まる", scores: { I: 2, E: 1, L: 1 } },
    ],
  },
  {
