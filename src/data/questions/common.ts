...
// ========================================
// 共通20問 + スライダー6問
// 正本: requirements_v2.md §7, v1質問設計
// ========================================
...
export const COMMON_QUESTIONS: Question[] = [
  // ===== 序盤ゾーン Q1-Q5 =====
  {
    ...
    options: [
      ...
      { label: "C", text: "周りが何頼むか聞いてから決める。被りたくない", scores: { C: 1, I: 1, L: -1 } },
      { label: "D", text: "30秒？余裕。メニュー表の写真で一番うまそうなやつ即決", scores: { G: 1, E: 1, I: 1, A: -1 } },
      { label: "E", text: "「もうちょっと待って」って言う。30秒じゃ足りん", scores: { A: 2, I: 1, E: -2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "「正直、ちょっと不安。でもやってやる」", scores: { G: 2, C: 1, L: -1 } },
      { label: "D", text: "「この会社、ここ変えたら伸びるのに、って3個くらい思いついた」", scores: { I: 3, L: 1, C: -1 } },
      { label: "E", text: "「全体像が見えない。まず情報収集から」", scores: { A: 2, E: 1, I: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "50点。良い日と悪い日の差が激しい", scores: { C: 1, I: 1, G: -1 } },
      { label: "D", text: "点数とかつけない。昨日の自分より前に進んでればOK", scores: { G: 2, I: 1, A: -1 } },
      { label: "E", text: "点数は他人がつけるもの。自分ではわからない", scores: { C: 2, A: 1, L: -2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "D", text: "列に並ばず、今日はコンビニコーヒーにする。時間のほうが大事", scores: { E: 1, A: 1, C: -1 } },
      { label: "E", text: "「あのバイトの子、ちゃんとフォローされてるのか？」と店長の采配が気になる", scores: { L: 2, C: 1, I: 1 } },
    ],
  },
  {
  ...
  // ===== 中盤ゾーンA Q6-Q10 =====
  {
    ...
    options: [
      ...
      { label: "C", text: "今回はA案に乗る。全員がA案なら、自分の直感のほうが間違ってる可能性が高い", scores: { A: 2, C: 1, L: -2 } },
      { label: "D", text: "A案で進めつつ、こっそりB案の検証も自分だけで進めておく", scores: { I: 2, E: 1, G: 1, C: -1 } },
      { label: "E", text: "「データが微妙ならどっちでも同じ。なら早く動いたほうがいい」とA案で即実行", scores: { E: 3, G: 1, I: -2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "「おめでとう。ちなみにこのパターンも想定してる？」と質問形式で気づかせる", scores: { C: 2, I: 1, A: 1 } },
      { label: "D", text: "落とし穴がどのくらい致命的か先に自分で検証する。大したことなければスルー", scores: { A: 3, E: 1, C: -1 } },
      { label: "E", text: "「実はここリスクあるから、一緒にリカバリ案だけ作っとこう」と巻き取る", scores: { E: 2, L: 1, G: 1, I: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "無視。日曜だぞ。明日対応しても死なない", scores: { I: 1, C: 1, G: -1, E: -1 } },
      { label: "D", text: "「了解です。明日朝イチで対応します」とだけ返す", scores: { C: 2, E: 1, L: -1 } },
      { label: "E", text: "開いて、10分で解決できそうならその場で片付ける", scores: { E: 3, G: 1, C: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "E", text: "エントリーしないけど、アイデアだけはノートに書いておく。いつか使う", scores: { I: 2, A: 1, L: -2 } },
    ],
  },
  {
  ...
  // ===== 中盤ゾーンB Q11-Q15 =====
  {
    ...
    options: [
      { label: "A", text: "「ご指摘ありがとうございます。確認して後ほど回答します」と流してプレゼン続行", scores: { E: 2, C: 2, L: -1 } },
      { label: "B", text: "「いえ、この前提で合っています。理由はこうです」と即座に根拠を返す", scores: { L: 3, A: 1, C: -1 } },
      { label: "C", text: "一瞬フリーズする。が、「確かに、ここは再検証の余地ありますね」と受け入れる", scores: { C: 2, A: 1, L: -1, G: -1 } },
      { label: "D", text: "「面白い視点ですね。前提を変えた場合のシナリオも次回お出しします」と攻めに変える", scores: { I: 2, L: 1, C: 1 } },
      { label: "E", text: "正直、頭が真っ白になる。でもプレゼンは最後までやり切る", scores: { G: 3, E: 1, L: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "E", text: "「飲みの場でそういう話するのやめよう」と話題を変える", scores: { E: 1, C: 1, L: -1, I: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "店員への態度。さりげなく気を遣える", scores: { C: 2, E: 1, L: -1 } },
      { label: "D", text: "知識の幅。何の話題にもついてこれる", scores: { A: 2, I: 1, G: 1 } },
      { label: "E", text: "余裕感。ガツガツしてない", scores: { L: 2, G: 1, C: -1 } },
    ],
  },
  {
    ...
    options: [
      { label: "A", text: "上司の判断に従う。「まだ1週間」は正論", scores: { A: 2, E: 1, L: -2 } },
      { label: "B", text: "データを追加で集めて「やっぱりダメそうです」と数字で上司を説得しにいく", scores: { A: 3, L: 1, E: 1 } },
      { label: "C", text: "上司には何も言わず、自分の裁量範囲で軌道修正を始める", scores: { E: 2, I: 1, G: 1, C: -2 } },
      { label: "D", text: "直感の根拠を言語化して「1週間待つのはリスク。今動くべき理由はこれです」と上申する", scores: { L: 3, A: 1, I: 1, C: -1 } },
      { label: "E", text: "「1週間待つ」と「今動く」のプランBを並行で準備しておく", scores: { E: 3, A: 1, I: 1 } },
    ],
  },
  {
  ...
  // ===== 後半ゾーン Q16-Q20 =====
  {
    ...
    text: "取引先の担当者。仕事はいい人だけど、メールの返信が毎回3日かかる。プロジェクトが遅れ始めてる。",
    options: [
      ...
      { label: "C", text: "その人の上司に「進捗のご相談」としてCCを入れる", scores: { L: 1, A: 1, E: 1, C: -2 } },
      { label: "D", text: "返信を待たずに進められるところを先に進める。相手に依存しない設計にする", scores: { E: 2, I: 2, C: -1 } },
      { label: "E", text: "「お忙しいところすみません」と前置きしつつ、対面でやんわり状況を伝える", scores: { C: 3, E: 1, L: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "「今夜は飲む。明日考える」。気持ちを切り替えるのが最優先", scores: { E: 1, C: 1, G: -1 } },
      { label: "D", text: "「次は絶対通す。何を変えるか、もう見えてる」。すでに次の打ち手が浮かんでる", scores: { G: 3, I: 1, A: -1 } },
      { label: "E", text: "「あの審査員の指摘、的外れだったけどな…」。正直、納得してない", scores: { L: 2, I: 1, C: -2, A: -1 } },
    ],
  },
  {
    ...
    subtext: "⚡ 直感2秒で答えて",
    options: [
      { label: "A", text: "「完璧を求めすぎるところです」", scores: { G: 1, A: 1, E: -1, C: -1 } },
      { label: "B", text: "「スピードです。もうちょっと速く動けるようになりたい」", scores: { A: 2, C: 1, E: -1 } },
      { label: "C", text: "「人に頼るのが苦手なところです」", scores: { G: 2, L: 1, C: -2 } },
      { label: "D", text: "「正直、自分ではよくわかってないです」", scores: { C: 2, I: 1, A: -1, L: -1 } },
      { label: "E", text: "「弱点って考えたことないです」", scores: { L: 2, G: 1, A: -1, C: -1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: "E", text: "特に何もしない。大人だし。個性を尊重すべき", scores: { I: 1, E: 1, C: -2 } },
    ],
  },
  {
